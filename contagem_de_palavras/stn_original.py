...
print("Onde", verdadeiros_positivos, "prct são verdadeiros positivos")
print("e", verdadeiros_negativos, "prct são verdadeiros negativos")

print("e", falsos_positivos, "prct são falsos positivos")
print("e", falsos_negativos, "prct são falsos negativos")

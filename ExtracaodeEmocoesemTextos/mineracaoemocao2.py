...
def retorna_Votacao_Emocao_Probabilidade_Por_Media_GeralTeste(idPessoa): 
    pessoa = idPessoa+1
    #print("estou na pessoa", pessoa)
...
def retorna_Votacao_Emocao_Probabilidade_Por_Media_GeralTeste2(vetor): 

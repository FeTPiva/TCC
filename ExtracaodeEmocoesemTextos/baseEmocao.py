...
('Eu não consigo dormir','neutro'),
('eu perdi o ônibus','neutro'),
('sente fortes contrações, mas quer ir para fora','neutro'),
('amarradão. ou talvez não .. amanhã','neutro'),
(' Foda-se davidbrussee! Eu só tenho 3 semanas ...','neutro'),
('tem trabalho esta tarde','neutro'),
('Você não iria deixar de seguir-me você faria? Então eu iria chorar','neutro'),
('se eu soprar um pneu, você realmente terá que enviar um pouco de fumaça de batman','neutro'),
('vou tomar um banho !!!!','neutro'),
('achocolatado é muito melhor através de um canudo.','neutro'),
('Diferença de horário e eu acabei de me envolver em coisas do dia a dia, então não tenho twittado. Conversarei em breve, devo dormir... em 6hrs','neutro'),
('de jeito nenhum! caramba que suga B! você está bem??','neutro'),
('a recessão. hotel dela estão reestruturando como as contas são feitas. adiciona um pouco mais de pressão no curto prazo, mas vamos lidar','neutro'),
('em casa sozinho sem muito o que fazer','neutro'),
('Não posso dar nenhum beijo no aniversário na jertronic..','neutro'),
('Brothers Bloom não vão abrir este fim de semana em El Paso. Vou comprar Brick e aproveitar até que eu possa assistir Brothers Bloom..','neutro'),
('diz que sinto falta de espreitar','neutro'),
('eu sinto falta Voobys!','neutro'),
('houve uma confusão com meu dentista esta tarde. então eles me remarcaram para amanhã às 9h.','neutro'),
('o que está acontecendo querida?','neutro'),
('Como pode ser tão difícil obter um corretor ortográfico para todo o sistema? Merda, eu me contentaria com uma suíte de escritório. Janela inútil estúpida','neutro'),
('trabalho às 6h. Tenho que ir para a cama cedo','neutro'),
(' Oh esse tempo é real?','neutro'),
('Isso foi frio como uma pedra, Louca ....?','neutro'),
('Tenho certeza que some1 vai gozar e brincar. Estou trabalhando até meia-noite.','neutro'),
('Desejo que chova mais onde estou','neutro'),
(' Bem, quase foi um bom dia ... acho que eu vou tentar novamente amanhã','neutro'),
('Bem, fiquei sem cerveja e fui embora. Não tenho certeza sobre o ETA. Esperando, esperando, esperando. Bleh vai ser uma longa noite.','neutro'),
(' amou o show, entrou no escritório 05:00 e sem rádio"','neutro'),
(' o que? Concentrei-me no Tom tanto que eu não vi meu amado Barack! Ah não! Devo votar para ambos! Pobre presidente tem apenas 626 votos.','neutro'),
('eu sei. Mas como eu disse, eu não tenho idéia quanto tempo leva para eles investigarem essas coisas."','neutro'),
('Awe! eu sinto falta do meu bebê','neutro'),
(' o que é com chocolates? Eu apenas não posso dizer não','neutro'),
('estou acordado demais agora vou tirar uma soneca esta tarde','neutro'),
('ainda precisa de mais 8 horas de sono','neutro'),
('onde estão todos meu melhores amigos?','neutro'),
('divertimento no sol hmmm inferno não é frio','neutro'),
('Eu não acho isso. Quero detalhes.','neutro'),
('Quem é Mary Poppins ???','neutro'),
('meu último tweet não enviou, telefone ruim','neutro'),
('stava assistindo Parental Control','neutro'),
('Feliz Aniversário! Espero que você tenha um dia incrível. Não te vi na noite passada!','neutro'),
('Eu ainda estou na academia e trabalho às 6:30 da manhã','neutro'),
('Um tolo faminto. Provavelmente nunca mais verei esse Krispy Kreme. Tinha que gostar. Eles fechando','neutro'),
('aeroporto? e você não apareceu hoje à noite!','neutro'),
('Fale sobre mim','neutro'),
('de volta da escola. último dia da Sr.Suhana como nosso FTOCU estava bem. Eu estou jogando ALTNOY inumeras vezes.','neutro'),
('estava tentando fazê-lo funcionar em um powerpoint sem sucesso.','neutro'),
('Sim, é terrível as cacatuas serem as mais difíceis de se viver, tão emocionantes. Ainda bem que ele te encontrou !!','neutro'),
('teria sido melhor, Fábio, se permitir que você toque todas as 3 músicas fornecidas. Eu apenas começo a dançar','neutro'),
('Ele nunca começou ...','neutro'),
('Com amigos como VaikO, Nedumaran, o LTTE não precisava de inimigos. Conselhos errados na hora errada levaram a numerosas mortes','neutro'),
('Eu amo guitarras e as toco. Eu acho que eles parecem magníficos. Se ao menos eu fosse melhor ... Se ao menos','neutro'),
(' Vamos Cavaleiro ... Tem sido bem mais de 4 horas','neutro'),
('NÃO está balançando minhas meias - Vá embora já !!','neutro'),
('dirigindo de volta para casa porque eu esqueci o pedaço de bolo para você','neutro'),
('eu estava tão perto dos tacos ... um local muito tarde','neutro'),
('não tenho tempo para comprar e preciso de um novo fichário','neutro'),
('25-man Ulduar é difícil ...','neutro'),
('isso está acontecendo para mim também','neutro'),
('entediado agora porque estava conversando com alguém, mas agora eles estão ocupados com outra coisa meio chata','neutro'),
('meu pai acabou de me dizer para ler um artigo sobre Kavya Shivashankar, a garota das ortografias, e ser mais como ela.','neutro'),
('Nenhuma venda feita hoje no trabalho. Varandas exploradas nos grandes teatros com colegas de trabalho. Um dia divertido, mas sem batatas fritas e dicas','neutro'),
('Gosto de batata frita também','neutro'),
('Digenis essa história lembra de viver em Portugal','neutro'),
('você é diabético? o mesmo acontece com meu pai','neutro'),
('eu vou fazer nachos amanhã. Melhor do que se ele próprio os tivesse feito.','neutro'),
('perverso, a que horas você está saindo? Por que você não pode passar a noite?','neutro'),
('existe um processo manual ... mas está demorando uma eternidade no meu banco de dados do Outlook ... pfft. produto de baixa qualidade da microsoft','neutro'),
('Quando vai jogar novamente?','neutro'),
('Me desculpe. Animado para amanhã à noite? Karaoke!! Recebendo nada especial para aniversário?','neutro'),
('É, além disso, é apenas um pouco demasiado longe de caminhar até Pinóquio para comer sushi','neutro'),
('isso é o que eu estava pensando, mas a única vez que vai ser é 1:00!','neutro'),
('Peeps ainda aqui. Tempos divertidos. Tenho que dormir também. Trabalhe no A.M. Algumas garotas legais e gostosas aqui. Mas nenhuma tão legal quanto ____________. Sentindo falta dela','neutro'),
(' Contando as horas de sol perdido até o fim de semana','neutro'),
('bom dia trabalho esta manhã ensolarada lol deixa pra lá','neutro'),
('Deedubau hahaha eu não sei se alguém ou alguma coisa sobre isso, exceto que eles têm poderes lol ... Eu vivo em minha própria bolha','neutro'),
('o amor é como uma guerra ,, fácil começar, difícil de terminar..fiuuhh ...','neutro'),
('pronto para ir para a Escola','neutro'),
('É bom não é! Nosso chalé está fora da vista, mas olhar vocês semelhantes aos queridos. Indo para casa novamente hoje','neutro'),
('aeroporto? e você não apareceu hoje à noite!','neutro'),
('para os gays eu só fiz 200 hoje à noite','neutro'),
('aposto que está frio no SR, hein? Não está aqui. Não paro de suar desde o meio dia, quando papai e eu estávamos fazendo as malas','neutro'),
('precisa de ter um aumento em seu salario','neutro'),
('a semana apenas não era a mesmo sem a performance de Adam Lambert!!!','neutro'),
('O link não funciona','neutro'),
('Gossip Girl, QUANDO VOCÊ VOLTARÁ!','neutro'),
('rimas infantis de hip hop','neutro'),
('Eu preciso que você me siga bem rápido, porque eu não posso te matar','neutro'),
(' No Aeroporto Internacional de Hong Kong. Tem que esperar por 3-4 horas para o nosso próximo vôo para Cebu.','neutro'),
('não consegue dormir e nada na TV !!','neutro'),
('KallieT oh ... você foi substituivel? não é bom o suficiente','neutro'),
('Aluno PGPM de onde? Eu próprio era um estudante do PGPM há cerca de 4 anos. Eu gostaria de poder ficar um','neutro'),
(' de volta ao trabalho .. sem distrações ..','neutro'),
('awwwwi nunca percebeu isso','neutro'),
('vocês mantiveram uma lista fixa? Eu esqueci de pedir um xx','neutro'),
('Primeira impressão de Silverlight: infelizmente, com base no que eu vi hoje, é bastante problemático','neutro'),
('a hora de ir para a cama, eu tenho que me levantar para ir ao trabalho','neutro'),
('Sorte, agora eu quero teleportar','neutro'),
('FC está finalmente de novo. já estava na hora. Eu odeio que isso continua acontecendo','neutro'),
('seriamente aborrecido, sem ninguém para conversar ... mas não cansado o suficiente para dormir','neutro'),
('ainda !! dê uma pausa no seu computador','neutro'),
('onde você está?','neutro'),
('Forever_Yours13 não estou em casa com meus gatos agora mesmo!','neutro'),
('o último show de Leno foi a noite.Eu gosto dele melhor do que Conan.','neutro'),
('eu não tenho nada disso','neutro'),
...
('Acho que não vou conseguir sair da cama amanhã de manhã, vamos nos ver!','neutro'),
('os tempos estão mudando','neutro'),
(' video não está disponível para nós estrangeiros','neutro'),
('à espera de ter pego!','neutro'),
('então não é certo?? você está bem?','neutro'),
('deseja que Dave Gilmour e Roger Waters se reencontrem para um concerto Pink Floyd','neutro'),
('em 1 cidade pequena + 2 altofalantes de carro soprados =','neutro'),
('Alguém me faca um cafeeeeee ......','neutro'),
('meu nariz está entupido','neutro'),
('última noite em Newport','neutro'),
('O bebe não era ele mesma após ter recebido as vacinas','neutro'),
(' assistindo The Biggest Loser na Hallmark. Nunca falha em me fazer chorar.','neutro'),
('que suga! quantos anos você tem realmente?','neutro'),
(' ainda confundem ...','neutro'),
('Eu não consigo entender !! está indo para as suas mensagens antigas?','neutro'),
('A natação é um não ir para mim','neutro'),
('meu verão é preenchido com um curso que dura o verão inteiro','neutro'),
('Para a cama !! Ainda exausto de Vegas','neutro'),
('tomou uma soneca quatro horas depois do trabalho hoje e não será capaz de dormir todos as noites é uma chatice','neutro'),
('Eu acordei e eu estou indo para a escola ... Por que me??','neutro'),
('A menos que convida vem com uma chave beta eu não vou ser de muita ajuda ...','neutro'),
('não onde eu vivo.','neutro'),
('Droga, oi Facebook? o que há de errado com você? Não é possível adicionar fotos','neutro'),
('4 mais seguidores .. siga-me e eu vou te amar!! * Faz beicinho * Por favor?','neutro'),
('eu nem tenho um WII! b gosta de xbox, então é isso que temos: você o usa?','neutro'),
('eu não consegui vê-lo hoje à noite','neutro'),
('segundo ao último episódio de jay leno, nunca mais será o mesmo! Boa noite twitter','neutro'),
('kisha Fakin... apenas a minha sorte!','neutro'),
('tão tenso ... tão emocional ... então não eu ..','neutro'),
('jogando assistindo a pessoas heterossexuais se conectando, mas não podem sair por outro motivo','neutro'),
('Eu não acho que foi também. Mas eu não me lembro.','neutro'),
('alguém tem vídeo de bate-papo ao vivo de JBs? eu estava na escola eu vi Joe abraçar e enfrentar Nick lol','neutro'),
('E então você descobre hoje que eles tiveram seu primeiro beijo!','neutro'),
('não sei por que tão cansado hoje tchau, hora de dormir','neutro'),
('sim. eu não posso comer, dor de garganta','neutro'),
('Bom dia. o que você tem para o café? Eu não posso decidir','neutro'),
('Mas agora ela se foi','neutro'),
('É 16:00 sexta-feira, ele saiu às 6h quinta-feira .... certamente ele deve estar lá agora','neutro'),
('uma boa noite de sono para todos','neutro'),
('Sim, é difícil mantê-lo. Às vezes não tenho certeza se vale a pena."','neutro'),
('Claro que sim. Estou atrasado.','neutro'),
('Como, obviamente, morando no Alasca, apenas algumas estações de rádio chegamos aqui.','neutro'),
('Oh não. Ei, o que minha tatuagem diz?','neutro'),
('Eu não tenho um videocassete ...','neutro'),
('Eu sei direito, mas espero que algo aconteça','neutro'),
('dor de cabeça enorme ... boa noite !!','neutro')]
